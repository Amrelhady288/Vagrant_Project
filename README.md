...
## Provisioning
Each VM is provisioned using a specific shell script located in the project root.
You can re-run the provisioning scripts without destroying the VMs by running:
